    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="form-datepicker w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal outline-none transition focus:border-[#40A579] active:border-[#40A579] dark:border-form-strokedark dark:bg-form-input dark:focus:border-[#40A579]"
