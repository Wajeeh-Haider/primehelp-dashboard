...
const SignIn: React.FC = () => {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    const provider = 'local'; // Adjust this if you want to support other providers
    ...
    try {
      const response = await fetch(`${API_URL}/login`, {
        ...
        body: JSON.stringify({ email, password, provider }), // Include the provider field
      });
        ...
        <div className="justify-center flex h-screen items-center">
            ...
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img
                  ...
                  alt="Logo"
                />
                <h1 className="text-2xl font-bold text-black">Prime Help</h1>
                {/* <img
              ...
              <p className="2lg:px-20">Services at your fingertips</p>
          ...
          <div className="w-full border-stroke dark:border-strokedark lg:w-1/2 lg:border-l-2">
            <div className="w-full p-4 sm:p-12.5 lg:p-17.5">
              <Link className="mb-5.5 block md:hidden" to="/">
                <h1 className="text-2xl font-bold text-black">Prime Help</h1>
                {/* <img
                  className="hidden dark:block"
                  src={"/images/logo/appLogo.png"}
              ...
              <h2 className="mb-9 text-3lg font-bold text-black dark:text-white ">
                Sign In to Prime Help
              </h2>
              <form>
                <div className="mb-4">
                ...
                <div className="mb-5">
                  <input
                    ...
                    className="w-full cursor-pointer rounded-lg border border-[#40A579] bg-[#40A579] p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
              </form>
            </div>
